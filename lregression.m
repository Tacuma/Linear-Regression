...
disp("Tacuma Solomon")
disp("@02580808")
disp("Machine Learning - Linear Regression ")
disp("")


data = dlmread("train.dat",",");    			 	   #Provides dimension information on the trainlr.dat file	
	fid = fopen("train.dat");      	 		 	   #Opens trainlr.dat
